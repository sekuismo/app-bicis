  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        console.log("Usuario de tipo guardia registrado con éxito");
        navigate("/homeAdmin");
      } catch (error) {
        let errorMsg = "Error al registrar al guardia";
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="mb-3">
            ...
            <input
              ...
              id="email"
              placeholder="Ingrese el correo electrónico del guardia"
          ...
          <div className="mb-3">
            ...
            <input
              ...
              id="name"
              placeholder="Ingrese el nombre del guardia"
          ...
          <div className="mb-3">
            ...
            <input
              ...
              id="password"
              placeholder="Contraseña del guardia"
